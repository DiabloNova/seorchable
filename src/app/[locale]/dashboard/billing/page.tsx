...
import { Receipt, Award, ArrowRight, ArrowLeft } from "lucide-react";
...
export default function BillingPage() {
  ...
  const strings = {
    ...
    desc: isRtl
      ? "مدیریت صورت‌حساب‌ها، فاکتورهای رسمی، ارتقای پلن‌های اشتراک و بررسی آمار مصرف ترافیک کراولر." :"Manage plans upgrade, track active crawl ingestion quotas, review enterprise transaction history, and configure corporate payments.",
