      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-[var(--text-secondary)] mt-1">
            {language === "fa" ?"مدیریت ارتباطات گراف دانش و چگونگی پیوند برند شما با مفاهیم کلیدی سیستم‌های هوش مصنوعی." :"Manage knowledge graph associations and how your brand links with key AI concept schemas."}
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {language === "fa" ?"ارزیابی ردپای هویت دیجیتال شما در ویکی‌دیتا و دیتابیس‌های گراف معنایی برداری." :"Evaluation of your digital identity footprint on Wikidata and semantic vector graph databases."}
            </CardDescription>
          </CardHeader>
