    ...
    <div className="space-y-6 animate-fade-in text-start">
      <div>
        <h1 className="text-2xl font-black text-[var(--text-primary)] font-display flex items-center gap-2.5">
          <Sparkles className="text-[var(--sky-blue-500)]" size={24} />
        ...
        <p className="text-xs text-[var(--text-secondary)] mt-1.5 max-w-2xl">
          {isRtl
            ? "پایش سهم صدای برند شما، بررسی میزان ارجاع‌ها، و شناسایی الگوهای ذکر نام برند شما در مدل‌های پاسخ‌دهی هوشمند."
            : "Review conversational engine visibility scores, brand share rates, and analyze direct response listings."}
        </p>
      </div>
      ...
      <Card className="border border-[var(--border)] bg-[var(--card)]">
        ...
        <CardContent className="text-xs text-[var(--text-secondary)] leading-relaxed space-y-2">
          <p>
            {isRtl
              ? "مسیر فعال سایدبار: ابزارهای رویت‌پذیری هوش مصنوعی > سنجش رویت‌پذیری هوش مصنوعی"
              : "Active Sidebar Navigation State: AI Visibility Tools > AI Visibility Audits"}
          </p>
