        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-8 relative z-10 text-center">
          <div className="max-w-3xl mx-auto space-y-3">
            ...
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed font-medium">
              {isFa
                ? "آدرس وب‌سایت خود را وارد کنید تا نخستین سیگنال‌های فنی و معنایی آن را ببینید."
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12 relative z-10">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-[var(--text-secondary)]">
              {isFa
                ? "با جریان‌های اصلی کار، از ممیزی تا پایش و بهینه‌سازی، آشنا شوید. اعداد این بخش صرفاً نمونه‌ای هستند."
                : "Explore the workflows the platform is designed to support. Values shown here are illustrative."}
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-[280px_1fr] gap-8 items-start">
            ...
            <div className="glass-panel rounded-3xl border border-[var(--glass-border)] bg-slate-950 text-slate-100 p-6 sm:p-8 min-h-[460px] shadow-2xl flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="pt-4 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
                <span className="text-xs text-slate-400 font-medium">{isFa ? "این‌ها بخشی از جریان کاری سئورچبل هستند." : "Ready to configure these modules for your target enterprise?"}</span>
                <button
