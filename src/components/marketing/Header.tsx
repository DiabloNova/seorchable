...
export function Header() {
  ...
  const solutionsItems = [
    {
      label: isFa ? "برای مدیران سئو" : "For SEO Managers",
      value: "seo-managers",
      href: `/${language}/solutions/seo-managers`,
    },
    {
      label: isFa ? "برای مدیران برند" : "For Brand Managers",
      value: "brand-managers",
      href: `/${language}/solutions/brand-managers`,
    },
    {
      label: isFa ? "برای آژانس‌ها" : "For Agencies",
      value: "agencies",
      href: `/${language}/solutions/agencies`,
    },
    {
      label: isFa ? "همه راهکارها" : "All Solutions",
      value: "solutions",
  ...
  const platformItems = [
    {
      label: isFa ? "قابلیت‌های پلتفرم" : "Features",
      value: "features",
      href: `/${language}/features`,
    },
    {
      label: isFa ? "صنایع هدف" : "Industries",
      value: "industries",
      href: `/${language}/industries`,
    },
    {
      label: isFa ? "معماری اکوسیستم" : "Ecosystem Architecture",
      value: "ecosystem",
      href: `/${language}/#ecosystem`,
    },
    {
      label: isFa ? "بررسی کلان پلتفرم" : "Platform Overview",
      value: "overview",
      href: `/${language}/#overview`,
    },
    {
      label: isFa ? "داستان چرخه محصول" : "Product Lifecycle Story",
      value: "story",
      href: `/${language}/#story`,
    },
  ];
    ...
    <header className="fixed top-0 inset-x-0 z-50 px-3 sm:px-6 pt-3">
      ...
      <div className="mx-auto max-w-7xl flex items-center gap-3">
        ...
        >
          <Menu
            size={20}
            className="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 transition-colors duration-300"
          />
        </button>
        ...
        >
          ...
          <nav className="hidden lg:flex items-center gap-1 xl:gap-2">
            ...
            >
              ...
              <span className="text-[9px] bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-1.5 py-0.5 rounded font-medium font-mono">
                API
              </span>
            </Link>
          </nav>
          ...
          <div className="relative w-full bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 rounded-t-3xl shadow-2xl p-6 pb-12 animate-in slide-in-from-bottom-full duration-300">
            ...
            <div className="space-y-6">
              ...
              <nav className="space-y-1">
                <a
                  href={`/${language}/features`}
                  className="block px-4 py-3 rounded-xl text-slate-700 dark:text-slate-300 font-medium hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors"
                >
              ...
              <div className="pt-4">
                <Link href={`/${language}/dashboard`}>
                  <button className="w-full py-4 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-semibold flex items-center justify-center gap-2 shadow-lg shadow-slate-900/20 dark:shadow-white/10 active:scale-[0.98] transition-transform">
                    <LogIn size={18} />
                    <span>
                      {isFa ? "ورود به حساب کاربری" : "Sign In to Dashboard"}
                    </span>
                  </button>
                </Link>
              </div>
